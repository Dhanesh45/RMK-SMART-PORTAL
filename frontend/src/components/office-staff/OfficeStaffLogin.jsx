  ...
  const handleLogin = async () => {
    try {
      const res = await axios.post(
        "http://localhost:5000/api/officestaff/login",
        {
          mail,
          password,
        },
      ...
      >
        ...
        <div
          style={{
            ...
            justifyContent: "center",
            alignItems: "center",
            borderRight: "1px solid rgba(14,73,71,1)",
          }}
        >
          <img
            src={loginimg}
        ...
        >
          ...
          <div style={{ padding: "3% 5% 5% 5%" }}>
            ...
            <div style={{ paddingBottom: "4%" }}>
              ...
              <input
                ...
                style={{
                  ...
                  padding: "1.25%",
                  borderRadius: "0.7vh",
                  border: "1px solid rgba(30, 46, 76, 1 )",
                  fontSize: "3vh",
                  fontWeight: "500",
                }}
              />
            ...
            >
              ...
              >
                ...
                <span
                  style={{
                    ...
                    borderRadius: "0.6vh",
                    backgroundColor: isChecked ? "#1E2E4F" : "#fff",
                    border: "2px solid rgba(17,73,71,1)",
                    position: "relative",
              ...
              <a
                href="#"
                style={{ color: "rgba(30, 46, 76, 0.7)", fontWeight: "600" }}
              >
                Forget Password?
              </a>
            </div>
            ...
            <div style={{ textAlign: "center" }}>
              <button
                ...
                style={{
                  ...
                  fontWeight: "600",
                  color: "white",
                  backgroundColor: "rgba(30, 46, 76, 1 )",
                }}
              >
                LOGIN
              </button>
